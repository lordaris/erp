...
var orderByFields = map[string]string{
    ...
    widgetbus.OrderByDateCreated:  "date_created",
    widgetbus.OrderByDateUpdated:  "date_updated",
}
...
func toAppWidget(widget widgetbus.Widget) Widget {
    return Widget{
        ...
        DateCreated: widget.DateCreated.Format(time.RFC3339),
        DateUpdated: widget.DateUpdated.Format(time.RFC3339),
    }
}
...
var orderByFields = map[string]string{
    ...
    "date_created":  widgetbus.OrderByDateCreated,
    "date_updated":  widgetbus.OrderByDateUpdated,
}
```
