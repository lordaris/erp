...
import (
	...
	"github.com/lordaris/erp/api/services/auth/build/all"
	...
	"github.com/lordaris/erp/foundation/keystore"
...
func main() {
	...
	log = logger.NewWithEvents(os.Stdout, logger.LevelInfo, "AUTH", events)
