...
import (
	...
	"github.com/lordaris/erp/api/services/sales/build/all"
	"github.com/lordaris/erp/api/services/sales/build/crud"
	"github.com/lordaris/erp/api/services/sales/build/reporting"
...
func main() {
	...
	log = logger.NewWithEvents(os.Stdout, logger.LevelInfo, "SALES", events)
